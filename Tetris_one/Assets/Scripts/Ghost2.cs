...
public class Ghost2 : MonoBehaviour {
    ...
    {
        if (GameObject.FindGameObjectWithTag("currentactivemino2") != null)
        {
            transform.position = GameObject.FindGameObjectWithTag("currentactivemino2").transform.position;
            transform.rotation = GameObject.FindGameObjectWithTag("currentactivemino2").transform.rotation;
            movedown();
        }
